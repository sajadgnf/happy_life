...
const Landing = ({ searchBarText, productsState }) => {
  ...
  const scrollHandler = (ref) => {
    ...
    setGridValue({
      ...gridValue,
      [ref.current.id]: ref.current.scrollLeft - cardWidth,
    });
  };
      ...
      <div className={classes.container}>
        ...
        <div>
          <div className={classes.sectionTitle}>
            ...
            <img className={classes.titlesIcon} src={clock} alt="clock" />
          </div>
        ...
        <div>
          <div className={classes.sectionTitle}>
            ...
            <img className={classes.titlesIcon} src={medal} alt="medal" />
            <div className={classes.titleUnderLine}></div>
          </div>
          <div className={classes.cards}>
            {gridValue.visited !== 0 && (
              <ArrowForwardIcon
                className={`${classes.scrollIcon} ${classes.backScroll}`}
                onMouseDown={() => scrollBackHandler(visited)}
              />
            )}
            <Grid
              container
            ...
            <ArrowBackIcon
              className={`${classes.scrollIcon} ${classes.forwardScroll}`}
              onMouseDown={() => scrollHandler(visited)}
            />
          </div>
        </div>
          ...
          {advertize.map((item) => (
            <Grid
              ...
              sx={{
                ...
                transition: "all .3s ease",
                backgroundColor: () =>
                  item.image === fiveG ? "#8D9097" : "#227872",
                ml: () =>
                  item.image === fiveG && {
                    xxs: "16px",
                    ml: "26px",
            ...
            >
                    ...
                    <Link to={item.link} className={classes.advertizeLink}>
                      ...
                      <Typography
                        sx={{
                          ...
                          borderWidth: { ml: 2 },
                          m: {
                            xxs: "5px 5px 5px 10px",
                            ml: "5px 10px 5px 10px",
                            lg: "5px 16px 5px 10px",
                          },
                          height: { xxs: 14, ml: 20 },
                        }}
                      >
              ...
              <img
                className={classes.advertizeLogo}
                src={item.image}
                alt="advertize logo"
              />
            </Grid>
        ...
        <div>
          <div className={classes.sectionTitle}>
            ...
            <img className={classes.titlesIcon} src={moneyBag} alt="medal" />
            <div className={classes.titleUnderLine}></div>
          </div>
          <div className={classes.cards}>
            {gridValue.sales !== 0 && (
              <ArrowForwardIcon
                className={`${classes.scrollIcon} ${classes.backScroll}`}
                onMouseDown={() => scrollBackHandler(sales)}
              />
            )}
            <Grid
              container
            ...
            <ArrowBackIcon
              className={`${classes.scrollIcon} ${classes.forwardScroll}`}
              onMouseDown={() => scrollHandler(sales)}
            />
          </div>
        </div>
      </div>
