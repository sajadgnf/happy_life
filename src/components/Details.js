...
const Details = ({ searchBarText, productsState }) => {
  ...
  useEffect(() => {
    axios
      .get(`https://happy-life-api.herokuapp.com/${section}/${id}`)
      .then((response) => {
  ...
  return loading ? (
    ...
    >
        ...
        >
          ...
          >
            <img
              ...
              src={selected.includes("like") ? heart1 : heart}
              alt="لایک"
            />
          </ToggleButton>
          <ToggleButton
          ...
          >
            <img
              className={classes.productIcons}
              src={selected.includes("share") ? send1 : send}
              alt="اشتراک"
            />
          </ToggleButton>
        </ToggleButtonGroup>
      ...
      <Container sx={{ width: { ml: "50%" }, pt: { ml: 8, xxl: 0 } }}>
        ...
        product.connection ||
        product.ears ? (
          <Typography className={classes.productProperty}>ویژگی ها</Typography>
        ) : (
          <>
        ...
        {product.internalMemory && (
          <Typography className={classes.productProperty}>
            حافظه داخلی : {product.internalMemory}{" "}
            {!isNaN(product.internalMemory) && "گیگابایت"}
          </Typography>
        )}
        {product.size && (
          <>
            ...
            <Box display="flex" justifyContent="center" alignItems="center">
              {checkCart(cartState, product.title, selectedColor.title) && (
                <Box className={classes.buttonsContainer}>
                  <Button
                    ...
                    onClick={() =>
                      dispatch(increase(product, selectedColor, section))
                    }
                  >
                    +
                  </Button>
                      ...
                      onClick={() => {
                        dispatch(
                          quantityCount(
                            ...
                            : dispatch(
                                removeItem(product, selectedColor, section)
                              )
                        );
                      }}
                    >
              ...
              {!checkCart(cartState, product.title, selectedColor.title) && (
                <Button
                  ...
                  onClick={() =>
                    dispatch(addItem(product, selectedColor, section))
                  }
                >
                  افزودن به سبد خرید
                </Button>
      ...
      >
        <Box
          ...
          sx={
            openSearch
              ? { xxs: { bottom: 68 }, ml: { bottom: 70 } }
              : { xxs: { bottom: -71 }, ml: { bottom: 0 } }
          }
        ></Box>
        <Box
          ...
          sx={
            !openSearch
              ...
              : {
                  xxs: { transform: "translate(0)", display: "inline-block" },
                  ml: { transform: "translateY(0px)", display: "inline-block" },
                }
          }
        >
          <input
            ...
            {searchResult.length ? (
              searchResult.map((item) => (
                ...
                >
                  ...
                  >
                    <img
                      className={classes.searchProductsImage}
                      src={item.image.main}
                      alt="عکس محصول"
                    />
