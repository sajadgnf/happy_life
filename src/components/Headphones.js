...
const Headphones = ({ show, productsState }) => {
  ...
  const [headphones, setHeadphones] = useState([
    ...productsState.products.headphones,
  ]);
  ...
  const brands = productsState.products.headphones
    .map((item) => item.brand)
    .filter(unique);
  productsState.products.headphones.map((item) =>
  ...
  useEffect(() => {
    if (categories.available && !categories.color) {
      if (categories.brand) {
        setHeadphones((headphones) =>
          headphones.filter((item) => item.available)
        );
      } else {
        setHeadphones(
          productsState.products.headphones.filter((item) => item.available)
        );
      }
    }
    ...
    if (!categories.available && !categories.color) {
      if (categories.brand) {
        setHeadphones(
          productsState.products.headphones.filter(
    ...
    if (categories.color) {
      if (categories.brand && categories.available) {
        ...
        setHeadphones(
          productsState.products.headphones.filter((item) =>
            item.colors.find((color) => color === categories.color)
          )
        );
      }
    ...
    if (categories.price === "lowestPrice")
      setHeadphones((headphones) =>
        headphones.sort((a, b) => a.price - b.price)
      );
  }, [categories]);
