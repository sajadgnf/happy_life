...
// functions
import { checkCart, quantityCount } from '../../helper/functions'
                        ...
                        >
                            ...
                            </Button>
                            {
                                ...
                                <Box className={classes.buttonsContainer}>
                                    <Button
                                        sx={{ fontSize: 30 }}
                                        onClick={() => dispatch(increase(item, colors(), section))}
                                    >
                                        +
                                    </Button>

                                    {
                                        ...
                                        <Typography fontFamily='shabnam' fontSize={26} fontWeight={700} sx={{ px: 2 }}>{quantityCount(cartState, item.title, color)}</Typography>
                                    }

                                    {
                                        ...
                                        <Button
                                            sx={{ fontSize: 30 }}
                                            onClick={() => {
                                                dispatch(quantityCount(cartState, item.title, color) > 1 ?
