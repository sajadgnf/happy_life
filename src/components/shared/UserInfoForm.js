        ...
        <Paper
            ...
            <Box className={classes.contentContainer} marginBottom={7}>
                ...
                <Box className={classes.content}>
                    ...
                    {
                        editInfo ?
                            <TextField value={info.name} name="name" onChange={e => infoHandler(e)} /> :
                            <Typography>{info.name}</Typography>
                    }
                </Box>
                <Box className={classes.content}>
                    <Typography className={classes.contentTitle}>پست الکترونیکی</Typography>
                    {
                        editInfo ?
                            <>
                                <TextField value={info.email} name="email" onChange={e => infoHandler(e)} onFocus={e => focusHandler(e)} />
                                {errors.email &&
                                    touched.email &&
                ...
                <Box className={classes.content}>
                    ...
                    {
                        editInfo ?
                            <TextField type="number" value={info.phoneNum} name="phoneNum" onChange={e => infoHandler(e)} /> :
            ...
            <Box className={classes.contentContainer}>
                <Box className={classes.content}>
                    ...
                    {
                        editInfo ?
                            <TextField type="number" value={info.nationalCod} name="nationalCod" onChange={e => infoHandler(e)} /> :
                ...
                <Box className={classes.content}>
                    ...
                    {
                        editInfo ?
                            <TextField value={info.job} name="job" onChange={e => infoHandler(e)} /> :
                ...
                <Box className={classes.content}>
                    ...
                    {
                        editInfo ?
                            <TextField type="date" value={info.birthDate} name="birthDate" onChange={e => infoHandler(e)} /> :
            ...
            {
                editInfo ?
                    <Button className={classes.infoButton} variant='contained' onClick={() => setEditInfo(false)}>
                        ثبت اطلاعات
                    </Button> :
                    <Button className={classes.infoButton} variant='contained' onClick={() => setEditInfo(true)}>
                        ویرایش اطلاعات
                    </Button>
            }
        </Paper>
