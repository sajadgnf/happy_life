import { Paper, Typography, Box, InputBase, Grid, Card, CardContent, Button } from '@mui/material';
...
const Support = ({ show }) => {
    ...
    const [open, setOpen] = useState(questions.map(question => { return { [question.title]: false } }))
    ...
    return (
        <Paper elevation={0} className={classes.container}>
                                    ...
                                    <CardContent >
                                        {
                                            !open[question.title] ?
                                                <Box
                                                    onClick={() => setOpen({ ...open, [question.title]: true })}
                                                    sx={{
                                                        display: "flex",
                                                        flexDirection: 'column',
                                                        alignItems: 'center',
            ...
            >
                ...
                >
                    چنانچه سوال خود را در لیست پرسش‌های متداول نیافتید و یا علاقمند به تماس با مجموعه هپی لایف هستید، می‌توانید از صفحه تماس با ما جهت ارتباط با هپی لایف استفاده کنید.
                </Typography>
